...
import styles from './SellHistoryDrawer.module.css';
...
const SellHistoryDrawer: React.FC<SellHistoryDrawerProps> = ({ onClose }) => {
  const [searchWord, setSearchWord] = useState('');

  return (
    <MyDrawerLayout title="판매 내역" onBack={onClose} mainClassName={styles.main}>
